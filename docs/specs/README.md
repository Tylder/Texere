...
| `engineering/build_system.md`             | 1.0     | Active | Backend, Frontend, DevOps   | Nx + TypeScript composite projects, `dependsOn` configuration, parallel execution, incremental builds, troubleshooting                                  |
...
| `engineering/documentation_spec.md`       | 0.1     | Draft  | All                         | Monorepo documentation standards: READMEs, feature specs, docstrings, comments, maintenance, checklists                                                 |
