...
| `REQ-graph_system_architecture`                       | REQ               | draft  | experimental | graph-system     | graph-system-architecture         | 'High-level requirements for the Nx package boundaries and dependency rules of the graph system'                                                                                                                  |
