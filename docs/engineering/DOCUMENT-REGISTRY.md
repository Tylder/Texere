...
| `REQ-graph_system_architecture`                       | REQ               | draft  | experimental | graph-system     | graph-system-architecture         | >-                                                                                                                                                                                                                |
| `REQ-graph_knowledge_system`                          | REQ               | draft  | experimental | knowledge-graph  | graph-knowledge-system            | Graph-based project memory with lifecycle-traceable, queryable nodes and deterministic current/as-of views                                                                                                        |
