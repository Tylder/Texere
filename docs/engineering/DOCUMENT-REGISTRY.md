...
| `REQ-graph-ingestion`                                 | REQ               | draft  | experimental | graph-system     | graph-ingestion                   | >-                                                                                                                                                                                                                |
| `REQ-graph-system-graph-ingestion-repo-scip-ts`       | REQ               | draft  | experimental | graph-system     | graph-ingestion-repo-scip-ts      | >-                                                                                                                                                                                                                |
| `REQ-graph-lifecycle`                                 | REQ               | draft  | experimental | graph-system     | graph-lifecycle                   | >-                                                                                                                                                                                                                |
| `REQ-graph-system-graph-lifecycle-assertions`         | REQ               | draft  | experimental | graph-system     | graph-lifecycle-assertions        | >-                                                                                                                                                                                                                |
| `REQ-graph-system-graph-policy-framework`             | REQ               | draft  | experimental | graph-system     | graph-policy-framework            | >-                                                                                                                                                                                                                |
| `REQ-graph-projection`                                | REQ               | draft  | experimental | graph-system     | graph-projection                  | >-                                                                                                                                                                                                                |
| `REQ-graph-system-graph-projection-current-truth`     | REQ               | draft  | experimental | graph-system     | graph-projection-current-truth    | >-                                                                                                                                                                                                                |
| `REQ-graph-store`                                     | REQ               | draft  | experimental | graph-system     | graph-store                       | >-                                                                                                                                                                                                                |
| `REQ-graph-system-graph-store-inmemory`               | REQ               | draft  | experimental | graph-system     | graph-store-inmemory              | >-                                                                                                                                                                                                                |
| `REQ-graph-system-graph-system-architecture`          | REQ               | draft  | experimental | graph-system     | graph-system-architecture         | >-                                                                                                                                                                                                                |
| `REQ-graph-system-graph-knowledge-system`             | REQ               | draft  | experimental | knowledge-graph  | graph-knowledge-system            | >-                                                                                                                                                                                                                |
